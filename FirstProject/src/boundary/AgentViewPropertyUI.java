            ...
            public void mousePressed(MouseEvent mouseEvent) {
                ...
                if (mouseEvent.getClickCount() == 2 && table.getSelectedRow() != -1) {
                    ...
                    case 0:
                        ...
                        UpdatePropertyUI updatePropertyUI = new UpdatePropertyUI(AgentViewPropertyUI.this, true,infoHold);
                        updatePropertyUI.setVisible(true);           
                        break;
                    case 1: 
                    	PropertyListing propertyListing = new PropertyListing();  
                    	SuspendPropertyController suspendPropertyController = new SuspendPropertyController(propertyListing);
