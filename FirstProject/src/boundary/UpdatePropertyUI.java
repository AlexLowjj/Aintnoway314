...
public class UpdatePropertyUI extends JDialog {
    private JTextField typeField, locationField, descriptionField, pricingField, statusField, sellerIdField, agentIdField;
    ...
    private void initializeDetailsPanel(GridBagConstraints constraints) {
        ...
        JTextField[] fields = {typeField, locationField, descriptionField, pricingField, statusField, sellerIdField, agentIdField};
    ...
    private void setupUpdatePropertyButton() {
        updateButton.addActionListener(e -> {
	        ...
	        PropertyListing propertyListing = new PropertyListing(type,location,description,pricing,status,filename,propertyIdHolder);
	        UpdatePropertyController updatePropertyController = new UpdatePropertyController(propertyListing);
		    String updatePropertyStatus = updatePropertyController.updateProperty(type,location,description,pricing,status,filename,propertyIdHolder);
...
//    }
    ...
    private void loadData() {
        // Load the property details similarly to how user details are loaded in UpdateUserUI
