...
import control.BuyerSelectAgentController;
import entity.Agent;

public class BuyerSelectAgentUI extends JFrame {
	...
	public BuyerSelectAgentUI(String type, int userId, int x, int y) {
		// set title
	...
	private void setComponents() {
		BuyerSelectAgentController controller = new BuyerSelectAgentController(userId);
		...
		if (agents != null) {
			...
			JOptionPane.showMessageDialog(BuyerSelectAgentUI.this, "Failed to find your agent.", "message",
					JOptionPane.WARNING_MESSAGE);
			BuyerSelectAgentUI.this.dispose();
		}
	}
	...
	private class AgentButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (type == "rate") {
				...
				BuyerRateAgentUI dialog = new BuyerRateAgentUI(BuyerSelectAgentUI.this, agentId, x, y);

			} else if (type == "review") {
				// create dialog for review agent
				BuyerReviewAgentUI dialog = new BuyerReviewAgentUI(BuyerSelectAgentUI.this, agentId, x, y);
			}
		}
	}
}