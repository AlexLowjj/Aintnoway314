		...
		createButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!password.equals(confirmPassword)) {
					...
					UserAccount userAccount = new UserAccount(username, email, name, phone, description, password,
							userType, filename);
					CreateUserController createUserController = new CreateUserController(userAccount);
					String createUserStatus = createUserController.createNewUser(username, email, name, phone,
							description, password, userType, filename);
					System.out.println(createUserStatus);

					if (createUserStatus.contains("already exists")) {
						JOptionPane.showMessageDialog(CreateUserUI.this, createUserStatus, "Error",
								JOptionPane.ERROR_MESSAGE);
					} else {
