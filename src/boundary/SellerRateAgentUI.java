...
import control.SellerRateAgentController;

public class SellerRateAgentUI extends JDialog {
	...
	public SellerRateAgentUI(SellerSelectAgentUI parent, int agentId, int x, int y) {
		// set basic setting
	...
	private class SubmitButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if (group.getSelection() == null) {
				JOptionPane.showMessageDialog(SellerRateAgentUI.this,
				...
				SellerRateAgentController controller = new SellerRateAgentController(parent.getUserId());

				// check if the rating is submitted successfully
				if (controller.rateAgent(agentId, rating)) {
					JOptionPane.showMessageDialog(SellerRateAgentUI.this, "Rating submitted successfully", "message",
							JOptionPane.INFORMATION_MESSAGE);
				} else {
					JOptionPane.showMessageDialog(SellerRateAgentUI.this, "Rating failed to submit", "message",
							JOptionPane.INFORMATION_MESSAGE);
				}

				// dispose this page
				SellerRateAgentUI.this.dispose();
			}
		}
	}
}