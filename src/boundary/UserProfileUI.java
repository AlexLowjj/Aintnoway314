...
public class UserProfileUI extends JFrame {
	...
	private void createRoleDialog() {
		...
		createButton.addActionListener(e -> {
			...
			if (updateStatus) {
				JOptionPane.showMessageDialog(frame, "Profile had created successfully", "Creation Status",
						JOptionPane.INFORMATION_MESSAGE);
				frame.dispose();
				displayRoles();
			} else {
				JOptionPane.showMessageDialog(frame, "Failed to create new profile: ", "Error",
